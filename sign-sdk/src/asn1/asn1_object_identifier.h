...
class CASN1ObjectIdentifier : public CASN1Object {
 ...
 public:
   ...
   */
  explicit CASN1ObjectIdentifier(const char* szObjId);

  virtual ~CASN1ObjectIdentifier() override;
